...
My biggest struggle was finding a simple way to reverse the complemented string. I researched different string-handling methods before settlign on the Python slice notation. 